...
export default function FeatureSection() {
    ...
    return (
        <section id="features" className="py-20 bg-white relative">
            {/* 배경 디자인 요소 */}
            <div className="absolute top-0 left-0 w-4 h-32 bg-green-600 opacity-20 rounded-r-full"></div>
            <div className="absolute bottom-0 right-0 w-4 h-32 bg-green-600 opacity-20 rounded-l-full"></div>
            ...
            <div className="container mx-auto px-6 relative">
                <div className="text-center mb-16 fade-in">
                    <div className="inline-block relative mb-4">
                        <h2 className="text-3xl font-bold">
                            <span className="text-green-600">TreeNote</span>의 강력한 기능
                        </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {features.map((feature, index) => (
                        <div key={feature.id} className="benefit-card stagger-item p-6 relative overflow-hidden">
                            {/* 카드 코너 장식 */}
                            <div className="absolute top-0 left-0 w-20 h-1 bg-green-500 opacity-80"></div>
                            <div className="absolute top-0 left-0 w-1 h-20 bg-green-500 opacity-80"></div>
                            
                            <div className="flex items-start mb-4">
                                <div className="feature-icon flex-shrink-0 relative">
                                    <span className="text-3xl relative z-10">{feature.icon}</span>
                                    <div className="absolute inset-0 bg-green-100 rounded-full transform -rotate-12 scale-90"></div>
                                </div>
                                <h3 className="text-xl font-bold text-gray-800 ml-4 pt-3 border-b-2 border-green-200 pb-2">{feature.title}</h3>
                            </div>
                            <p className="text-gray-600 pl-4 border-l border-green-100">{feature.description}</p>
                            
                            {/* 카드 번호 */}
                            <div className="absolute bottom-4 right-4 w-8 h-8 rounded-full bg-green-50 flex items-center justify-center">
                ...
                <div className="mt-20 fade-in relative">
                    <div className="benefit-card overflow-hidden border-t-4 border-green-500">
                        <div className="absolute top-1/2 right-0 w-24 h-24 bg-green-50 rounded-full transform translate-x-1/2 -translate-y-1/2"></div>
                        <div className="absolute bottom-0 left-12 w-16 h-16 border-2 border-green-200 rounded-full transform -translate-y-1/2 opacity-50"></div>
                        ...
                        <div className="bg-gray-900 p-6 rounded-lg font-mono text-sm relative z-10">
                            <div className="text-green-400 mb-2"># 녹음 중...</div>
                            ...
                            <div className="mt-4">
                                <p className="text-blue-400 mb-2"># AI 구조화 중...</p>
                                <pre className="text-yellow-300 pl-4 border-l-2 border-green-500">
                                    {`● 오늘의 강의
  ├─ 반응 속도 이론
  ├─ 촉매
  │  ├─ 역할
