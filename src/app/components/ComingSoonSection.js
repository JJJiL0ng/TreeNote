              ...
              <div className="relative w-full max-w-md mx-auto">
                <div className="bg-gray-100 border border-gray-300 rounded-lg p-4 font-mono text-center text-lg mb-2 flex items-center justify-center relative">
                  ...
                  <button 
                    ...
                    className="absolute right-3 text-gray-500 hover:text-[#005DE9] transition-colors"
                    aria-label="쿠폰 코드 복사"
                  >
          ...
          <div className="text-center">
            ...
            <form onSubmit={handleSubmitContact} className="max-w-md mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <button 
                  type="submit" 
                  className={`bg-[#005DE9] text-white font-semibold px-4 py-3 rounded-lg hover:bg-[#004bb7] transition-colors ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                  disabled={isSubmitting}
                >
            ...
            {contactStatus.message && (
              <p className={`text-sm mt-2 ${contactStatus.isError ? 'text-red-500' : 'text-[#005DE9]'}`}>
                {contactStatus.message}
              </p>
            )}
